...
The table lists the 21 published DPFs in the Suite. **Published - N patterns** gives the number of pattern bodies in the linked publication. Each DPF has a full pattern index.
