...
The public folder contains nineteen published DPFs with 319 pattern bodies. Start with the working question nearest to yours. Each linked publication provides its full searchable pattern index.
